...
describe("ColumnList", () => {
  ...
  test("displays column type without size specification", () => {
    ...
    expect(html).toContain(">numeric</span>");
    expect(html).not.toContain(">numeric(10,2)</span>");
  ...
  test("strips varchar size from type display", () => {
    ...
    expect(html).toContain(">varchar</span>");
    expect(html).not.toContain(">varchar(255)</span>");
